...
**Table 1.** Associations between individual predictor variables and the effect sizes of dominance rank on female reprodutive success.
...
d_associated <- data.frame(predictorvariable_associated,metaforresults_associated,rethinkingresrethinkingresults_associatedults)

colnames(d_associated)<-c("Predictor variable","Metafor compatibility estimate of association","Rethinking compatibility estimate of association")
...
colnames(d_notassociated)<-c("Predictor variable","Metafor compatibility estimate of association","Rethinking compatibility estimate of association")
