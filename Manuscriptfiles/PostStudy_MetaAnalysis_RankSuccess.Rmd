...
meta_sexratio <- rma.mv(yi=Fishers_Z_r, V=Variance, mods=~ SexRatio, data=dat, method="REML", random=list(~1|StudyRef,~1|SpeciesRef))
meta_sexratio
...
meta_sexualdimorphism <- rma.mv(yi=Fishers_Z_r, V=Variance, mods=~ SexualDimorphism_MaleWeightOverFemaleWeight, data=dat, method="REML", random=list(~1|StudyRef,~1|SpeciesRef))
meta_sexualdimorphism

metafor_phylogenetic_sexualdimorphism <- rma.mv(Fishers_Z_r, Variance,
                                      mod =~SexualDimorphism_MaleWeightOverFemaleWeight,
                                      random=list(~ 1 | SpeciesIncluded, # linking the species to the phylogeny
                                                  ~ 1 | Latin, # observations from the same species might be similar to each other, even if those from closely related species are not
                                                  ~ 1 | StudyRef),  # accounting for observations from the same publication
                                      R = list(SpeciesIncluded = phylo_cor), # reflecting the phylogenetic relatedness
...
sexualdimorphismdat<-dat[is.na(dat$SexualDimorphism_MaleWeightOverFemaleWeight)==F,]
...
dat_list_sexualdimorphism <- list(
  ...
  S = standardize(sexualdimorphismdat$SexualDimorphism_MaleWeightOverFemaleWeight)
)
