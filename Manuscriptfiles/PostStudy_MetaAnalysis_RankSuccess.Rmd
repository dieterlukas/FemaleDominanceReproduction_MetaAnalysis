...
**Figure 1.** Phylogenetic distribution of the effect sizes in our dataset. We found most effect sizes from studies of primate social groups (green: 254 effect sizes from 35 different species), followed by ungulates (blue: 74 effect sizes from 21 different species), rodents (yellow: 63 effect sizes from 17 species), and carnivores (purple: 51 effect sizes from 12 species), plus a single effect size from hyraxes (red) and marsupials (aqua). Average effect sizes vary even among closely related species, though there are slight differences among Orders (e.g. carnivores generaly have large effect sizes, for more details see below).
