...
**Table 1.** Overview of results of in univariate analyses indicating whether **we found an association between individual variables with variation in effect sizes of dominance rank on female reproductive success**. The table presents for each variable which direction of association we predicted, the association we observed, and the respective estimates of the association when accounting for shared
