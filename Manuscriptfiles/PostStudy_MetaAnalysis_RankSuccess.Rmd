...
ADD: Time scales / plural breeders / type of benefit
test the mechanism of rank acquisition in relation with the timescale of the study as proposed here. Would it be possible to divide the sample into three subsample: short studies, medium studies and long studies, and then add the mechanism of rank acquisition (condition, age, nepotism) as a moderator in each case…?
