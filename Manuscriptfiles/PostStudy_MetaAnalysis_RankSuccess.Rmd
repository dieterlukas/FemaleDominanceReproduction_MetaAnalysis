...
**Sexual dimorphism in body weight**: average weight of males of that species divided by average weight of males of that species (based on data in:)
...
**Adult sex ratio**: the ratio of the average number of males divided by the average number of females per social group of that species. We took species' averages to reflect potential sexual conflict because several of the studies from which we extracted effect sizes had captive or experimental settings or only reported the number of females that were included in the study.
